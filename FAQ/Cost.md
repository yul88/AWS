...
* 如果负载把2个vCPU跑满，每小时净消耗100%x2x60-36=84分，透支积分能连续跑10.28小时。
* 如果负载把1个vCPU跑满，另一个空闲，每小时净消耗100%x60-36=24分，透支积分能连续跑36小时。
* 如果负载把1个vCPU跑到60%，另一个空闲，不消耗积分也不累计积分(60%x60-36=0)。
